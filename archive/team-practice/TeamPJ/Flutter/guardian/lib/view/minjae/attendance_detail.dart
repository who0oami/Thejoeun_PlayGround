...
import 'package:guardian/vm/minjae/attendance_riverpod.dart';
              ...
              children: [
                ...
                Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      _statBox('조퇴', stats['조퇴']!, Colors.grey),
                    ],
                  ),
                ),
                ...
                Row(
                  children: const [
                    ...
                    Expanded(
                      child: Text('출석현황', style: TextStyle(fontWeight: FontWeight.bold)),
                    ),
                    Expanded(
                      child: Text('메모', style: TextStyle(fontWeight: FontWeight.bold)),
                    ),
                  ],
                ),
                      ...
                      : ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            ...
                            final date = DateFormat('M/d')
                                .format(DateTime.parse(att.attendance_start_time));
